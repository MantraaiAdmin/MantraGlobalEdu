...
import { FileText, Calendar, FolderOpen, Bell, Loader2 } from 'lucide-react';
import { getAccessToken } from '@/lib/auth';
import { fetchStudentDashboard, fetchStudentApplications } from '@/services/api.service';
...
export default function StudentDashboardPage() {
  ...
  const statItems = [
    ...
    { label: 'Documents Uploaded', value: String(stats?.documentsUploaded ?? 0), icon: FolderOpen },
